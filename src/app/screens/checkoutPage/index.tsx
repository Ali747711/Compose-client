...
const CheckoutPage = () => {
  ...
  const { cartItems, currency, getItemQuantity, deliveryDate, authUser } =
    useGlobals();
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      await Promise.all([getUserAddresses(), getPayments()]);
      setLoading(false);
    };
    fetchData();
  ...
  const deliveryFee = itemsTotal > 25000 ? 0 : 4750;
  const serviceFee = 12878;
  const subtotal = itemsTotal + deliveryFee + serviceFee + selectedTip;
      ...
      <div className="lg:hidden sticky top-0 bg-white z-20 border-b border-gray-200">
        <div className="px-3 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-main-text">Checkout</h1>
          </div>
      ...
      <div className="max-w-7xl mx-auto p-3 lg:p-5">
        ...
        <div className="hidden lg:flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-main-text">Checkout</h1>
            </div>
          </div>
